...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (jedi deferred go-eldoc go-snippets go-gen-test go-add-tags go-tag go-impl go-errcheck go-gopath go-autocomplete go golint go-mode rubocop ruby-additional ruby-tools lua-mode beginend string-edit prodigy dockerfile-mode elisp-slime-nav whitespace-cleanup-mode highlight-escape-sequences restclient guide-key ido-at-point ido-vertical-mode smartparens yasnippet dired-details flx-ido f flx flycheck-pos-tip flycheck fill-column-indicator markdown-mode visual-regexp htmlize move-text paredit hydra inflections edn magit ample-zen-theme wgrep)))
